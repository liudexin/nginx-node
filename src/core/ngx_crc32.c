...
ngx_crc32_table_init(void)
{
    ...
    //判断ngx_crc32_table_short 这个变量的地址是否是按照ngx_cachelien_size 进行的内存对齐的
    // 可以参考ngx_align 对其函数理解
    ...
    // 多分配ngx_cacheline_size 个地址空间，以防作对ngx_cacheline_size 内存对齐后，申请的内存地址空间不够用
