...
// A的十六进制ASCII为0X41，a的十六进制ASCII为0x61,两者之差为0x20
// 参考资料：http://blog.csdn.net/davintanger/article/details/7706573
 ...
 *  ngx_memcpy 和ngx_cpymem的区别主要在于返回地址上，ngx_memcpy 返回dst的首地址. 而ngx_cpymem返回的是dst的尾地址加一(即dst + n)
 */
