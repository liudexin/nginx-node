...
// 将src 中的前n个字符，转换为小写字符，然后存储到dst中
void
...
// 将 src中的前n个字符copy 到 dst中，并返回dst的反方向地址
u_char *
...
//复制src字符串
//在pool中申请一块内存空间dst，将字符串src复制到dst,并返回dst的地址
u_char *
...
// va_list 参考：http://baike.baidu.com/view/1213054.htm
u_char * ngx_cdecl
